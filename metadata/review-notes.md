...
Winchester is an offline simulator of the mechanical hard disks of 1993 to 2012. It computes the motion of the head over a simulated volume and renders the sound that motion would make. Nothing is recorded, sampled or downloaded, and the app never sends anything anywhere: there is no account, no server, no analytics and no network access at all. The app has no paid content or feature.
