...
Winchester is an offline simulator of the mechanical hard disks of 1993 to 2012. It computes the motion of the head over a simulated volume and renders the sound that motion would make. Nothing is recorded, sampled or downloaded, and the app never sends anything anywhere: there is no account, no server, no analytics and no network access at all. The only outbound links are under Settings → About (website, support, privacy policy, source code, App Store listing and developer page); they open in Safari or the App Store. The app has no paid content or feature. Settings → Support Winchester offers three optional consumable tips (io.github.glandais.winchester.tip.small, .medium, .large) through In-App Purchase; they unlock nothing and the app just says thank you. There is no external tip or donation link.
